...
class TestUserImagesTable extends AbstractTableGateway implements AdapterAwareInterface
{
    /**
     ...
     * @var string
     */
    protected $table = 'test-user_images';
    const TABLE_NAME = 'test-user_images';
