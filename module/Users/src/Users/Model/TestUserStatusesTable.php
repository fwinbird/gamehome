...
class TestUserStatusesTable extends AbstractTableGateway implements AdapterAwareInterface
{
    /**
     ...
     * @var string
     */
    protected $table = 'test-user_statuses';
    const TABLE_NAME = 'test-user_statuses';
